//! Failure-cleanup lease and ownership tests.
//!
//! Split out of `runner_tests.rs`, which reached the 1000-line file limit.
//! This section already carried its own imports and its own banner, so it was
//! the natural seam: these tests are about lease authority and workspace
//! ownership during `failure_cleanup`, not about the runner's step loop.
...
use super::runner_tests::test_workflow_config;
use super::*;
