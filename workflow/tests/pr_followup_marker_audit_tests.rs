...
const P03_TOUCHED_RUST_FILES: [&str; 9] = [
    ...
    "src/components/github/pr_followup_artifacts.rs",
    "src/components/github/pr_followup_types.rs",
    "src/components/github/github_pr.rs",
    "src/components/github/github_feedback/mod.rs",
    "src/components/github/feedback_eval/mod.rs",
