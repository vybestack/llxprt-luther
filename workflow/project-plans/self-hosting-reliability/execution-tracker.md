...
- Plan Status: **COMPONENT-QUALIFIED** — `RecoveryProtocolV1` and typed merge are
  qualified under deterministic injected observations. This is **not** evidence of
  self-hosting viability; see `docs/architecture/product-gates.md`.
