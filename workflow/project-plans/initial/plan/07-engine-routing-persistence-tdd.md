# Phase 07: Behavioral TDD for Engine Execution, Loops, and Persistence

## Phase ID
`PLAN-20260404-INITIAL-RUNTIME.P07`

## Prerequisites

- Required: Phase 06 verification completed
- Verification marker required: `project-plans/initial/plan/.completed/P06A.md`
...
# Test files exist
test -f tests/engine_execution_integration.rs && echo "OK" || echo "FAIL: engine test missing"
test -f tests/persistence_integration.rs && echo "OK" || echo "FAIL: persistence test missing"
test -f tests/engine_resume_integration.rs && echo "OK" || echo "FAIL: resume test missing"

# Test counts
echo "engine_execution tests: $(grep -c '#\[test\]\|#\[rstest\]' tests/engine_execution_integration.rs)"
echo "persistence tests: $(grep -c '#\[test\]\|#\[rstest\]' tests/persistence_integration.rs)"
echo "resume tests: $(grep -c '#\[test\]\|#\[rstest\]' tests/engine_resume_integration.rs)"
...
- [ ] Prerequisite marker exists (`P06A`)
...
Create: `project-plans/initial/plan/.completed/P07.md`
